...
export default function ModelForm({ taskData, onTaskDataChange }: { taskData: any, onTaskDataChange: (key: string, value: any) => void }) {
  return <div className="space-y-4">
    <div className="w-full">
      <Label>深度爬虫</Label>
      <Select value={taskData.searchModel} onValueChange={(value) => onTaskDataChange("searchModel", value)}>
        <SelectTrigger>
      ...
      <div className="w-full flex justify-between space-x-4">
        <div className="flex-1">
          ...
          <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => onTaskDataChange("maxDepth", Number(e.target.value))}
          />
        </div>
        <div className="flex-1">
          ...
          <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => onTaskDataChange("maxLinks", Number(e.target.value))}
          />
        </div>
      </div>
    )}
    ...
    <div className="w-full">
      <Label>数据抓取模式</Label>
      <Select value={taskData.matchType} onValueChange={(value) => onTaskDataChange("matchType", value)}>
        <SelectTrigger>
